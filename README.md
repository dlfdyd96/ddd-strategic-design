...
| 메뉴 생성 정책     | MenuCreationPolicy          | 메뉴 생성 정책은 메뉴가 올바르게 생성되었는지 검증하는 정책이다.             |
| 메뉴 이름        | MenuName                    | 메뉴 이름은 메뉴를 식별하는 이름이다.                            |
| 메뉴 이름 정책     | MenuNamePolicy              | 메뉴 이름 정책은 메뉴 이름이 올바른지 검증하는 정책이다.                 |
...
| 메뉴 노출 정책     | MenuExposurePolicy          | 메뉴 노출 정책은 메뉴가 올바르게 노출되었는지 검증하는 정책이다.             |
|              |                             |                                                  |
| 메뉴 그룹        | MenuGroup                   | 메뉴 그룹은 메뉴를 분류하는 단위이다.                            |
| 메뉴 그룹 이름     | MenuGroupName               | 메뉴 그룹 이름은 메뉴 그룹을 식별하는 이름이다.                      |
| 메뉴 그룹 이름 정책  | MenuGroupNamePolicy         | 메뉴 그룹 이름 정책은 메뉴 그룹 이름이 올바른지 검증하는 정책이다.           |
| 메뉴 그룹 생성 정책  | MenuGroupCreationPolicy     | 메뉴 그룹 생성 정책은 메뉴 그룹이 올바르게 생성되었는지 검증하는 정책이다.       |
|              |                             |                                                  |
| 메뉴 상품        | MenuProduct                 | 메뉴 상품은 상품과 수량을 포함한다.                             |
|              |                             |                                                  |
| 상품           | Product                     | 상품은 상품 이름과 가격을 포함한다.                             |
| 상품 이름        | ProductName                 | 상품 이름은 상품을 식별하는 이름이다.                            |
| 상품 이름 정책     | ProductNamePolicy           | 상품 이름 정책은 상품 이름이 올바른지 검증하는 정책이다.                 |
| 상품 가격        | ProductPrice                | 상품 가격은 상품의 가격이다.                                 |
| 상품 가격 정책     | ProductPricePolicy          | 상품 가격 정책은 상품 가격이 올바르게 변경되었는지 검증하는 정책이다.          |
| 상품 생성 정책     | ProductCreationPolicy       | 상품 생성 정책은 상품이 올바르게 생성되었는지 검증하는 정책이다.             |
| 상품 가격 변경 정책  | ProductPriceChangePolicy    | 상품 가격 변경 정책은 상품 가격이 올바르게 변경되었는지 검증하는 정책이다.       |
|              |                             |                                                  |
...
| 주문 배달완료      | OrderDelivered              | 주문 배달완료는 주문이 배달 완료된 것을 나타낸다.                     |
| 주문 완료        | OrderCompleted              | 주문 완료는 주문이 완료된 것을 나타낸다.                          |
| 주문 유형        | OrderType                   | 주문 유형은 주문의 유형을 나타낸다.                             |
| 배달           | Delivery                    | 배달은 배달 주문을 나타낸다.                                 |
| 포장           | Takeout                     | 포장은 포장 주문을 나타낸다.                                 |
| 매장 식사        | EatIn                       | 매장식사는 매장 주문을 나타낸다.                               |
| 주문 항목        | OrderLineItem               | 주문 항목은 메뉴와 수량을 포함한다.                             |
| 주문 항목 정책     | OrderLineItemPolicy         | 주문 항목 정책은 주문 항목이 올바르게 생성되었는지 검증하는 정책이다.          |
| 주문 항목 가격     | OrderLineItemPrice          | 주문 항목 가격은 주문 항목의 가격이다.                           |
| 배달 주문        | DeliveryOrder               | 배달 주문은 배달 주소를 포함한다.                              |
| 배달 주문 생성 정책  | DeliveryOrderCreationPolicy | 배달 주문 생성 정책은 배달 주문이 올바르게 생성되었는지 검증하는 정책이다.       |
| 배송 주소        | DeliveryAddress             | 배송 주소는 배달 주소를 나타낸다.                              |
| 배송 주소 정책     | DeliveryAddressPolicy       | 배송 주소 정책은 배송 주소가 올바른지 검증하는 정책이다.                 |
| 포장 주문        | TakeoutOrder                | 포장 주문                                            |
| 포장 주문 생성 정책  | TakeoutOrderCreationPolicy  | 포장 주문 생성 정책은 포장 주문이 올바르게 생성되었는지 검증하는 정책이다.       |
| 매장 주문        | EatInOrder                  | 매장 주문                                            |
| 매장 주문 생성 정책  | EatInOrderCreationPolicy    | 매장 주문 생성 정책은 매장 주문이 올바르게 생성되었는지 검증하는 정책이다.       |
| 주문 테이블       | OrderTable                  | 주문 테이블은 주문을 받는 테이블이다.                            |
| 배달 요청        | DeliveryRequest             | 배달 요청은 배달 요청을 나타낸다.                              |
| 주문 수락 정책     | OrderAcceptancePolicy       | 주문 수락 정책은 주문이 올바르게 수락되었는지 검증하는 정책이다.             |
| 조리 완료 정책     | OrderServingPolicy          | 조리 완료 정책은 주문이 올바르게 조리 완료되었는지 검증하는 정책이다.          |
| 배달 시작 정책     | DeliveryStartPolicy         | 배달 시작 정책은 주문이 올바르게 배달 시작되었는지 검증하는 정책이다.          |
| 배달 완료 정책     | DeliveryCompletionPolicy    | 배달 완료 정책은 주문이 올바르게 배달 완료되었는지 검증하는 정책이다.          |
| 주문 완료 정책     | OrderCompletionPolicy       | 주문 완료 정책은 주문이 올바르게 완료되었는지 검증하는 정책이다.             |
|              |                             |                                                  |
| 주문 테이블       | OrderTable                  | 주문 테이블은 주문을 받는 테이블이다.                            |
| 주문 테이블 이름    | OrderTableName              | 주문 테이블 이름은 주문 테이블을 식별하는 이름이다.                    |
| 주문 테이블 이름 정책 | OrderTableNamePolicy        | 주문 테이블 이름 정책은 주문 테이블 이름이 올바른지 검증하는 정책이다.         |
| 주문 테이블 생성 정책 | OrderTableCreationPolicy    | 주문 테이블 생성 정책은 주문 테이블이 올바르게 생성되었는지 검증하는 정책이다.     |
| 테이블 비우기 정책   | OrderTableClearPolicy       | 테이블 비우기 정책은 주문 테이블이 올바르게 비워졌는지 검증하는 정책이다.        |
| 손님 수 변경 정책   | GuestNumberChangePolicy     | 손님 수 변경 정책은 주문 테이블의 손님 수가 올바르게 변경되었는지 검증하는 정책이다. |
